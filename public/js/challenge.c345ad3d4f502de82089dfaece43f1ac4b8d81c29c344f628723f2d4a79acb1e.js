...
(() => {
  ...
  var require_toast = __commonJS({
    "ns-hugo-imp:C:\\Users\\n1NjaM0nk3y\\Coding\\n1NjaMonk3y\\themes\\hackropole\\assets\\js\\vendor\\bootstrap\\toast.js"(exports, module) {
      (function(global, factory) {
        ...
        class Toast5 extends BaseComponent {
          constructor(element, config) {
            super(element, config);
            this._timeout = null;
          ...
          static jQueryInterface(config) {
            return this.each(function() {
              const data = Toast5.getOrCreateInstance(this, config);
              if (typeof config === "string") {
                if (typeof data[config] === "undefined") {
                  throw new TypeError(`No method named "${config}"`);
                }
        ...
        componentFunctions_js.enableDismissTrigger(Toast5);
        index_js.defineJQueryPlugin(Toast5);
        return Toast5;
      });
    }
  });

  // ns-hugo-imp:C:\Users\n1NjaM0nk3y\Coding\n1NjaMonk3y\themes\hackropole\assets\js\vendor\bootstrap\util\backdrop.js
  var require_backdrop = __commonJS({
    "ns-hugo-imp:C:\\Users\\n1NjaM0nk3y\\Coding\\n1NjaMonk3y\\themes\\hackropole\\assets\\js\\vendor\\bootstrap\\util\\backdrop.js"(exports, module) {
      (function(global, factory) {
  ...
  // ns-hugo-imp:C:\Users\n1NjaM0nk3y\Coding\n1NjaMonk3y\themes\hackropole\assets\js\vendor\bootstrap\util\focustrap.js
  var require_focustrap = __commonJS({
    "ns-hugo-imp:C:\\Users\\n1NjaM0nk3y\\Coding\\n1NjaMonk3y\\themes\\hackropole\\assets\\js\\vendor\\bootstrap\\util\\focustrap.js"(exports, module) {
      (function(global, factory) {
  ...
  // ns-hugo-imp:C:\Users\n1NjaM0nk3y\Coding\n1NjaMonk3y\themes\hackropole\assets\js\vendor\bootstrap\util\scrollbar.js
  var require_scrollbar = __commonJS({
    "ns-hugo-imp:C:\\Users\\n1NjaM0nk3y\\Coding\\n1NjaMonk3y\\themes\\hackropole\\assets\\js\\vendor\\bootstrap\\util\\scrollbar.js"(exports, module) {
      (function(global, factory) {
  ...
  // ns-hugo-imp:C:\Users\n1NjaM0nk3y\Coding\n1NjaMonk3y\themes\hackropole\assets\js\vendor\bootstrap\modal.js
  var require_modal = __commonJS({
    "ns-hugo-imp:C:\\Users\\n1NjaM0nk3y\\Coding\\n1NjaMonk3y\\themes\\hackropole\\assets\\js\\vendor\\bootstrap\\modal.js"(exports, module) {
      (function(global, factory) {
  ...
  // ns-hugo-imp:C:\Users\n1NjaM0nk3y\Coding\n1NjaMonk3y\themes\hackropole\assets\js\lib\writeupVoteBtn.js
  var import_toast3 = __toESM(require_toast());
      ...
      el.addEventListener("click", (event) => {
        ...
        if (HackropoleApi.isLogged()) {
          ...
          HackropoleApi.voteSolution(writeup).then((d) => {
            ...
            const toast = new import_toast3.default(document.getElementById("toast-api-error"));
            toast.show();
          });
        } else {
          const toast = new import_toast3.default(document.getElementById("toast-api-need-login"));
          toast.show();
        }
      });
    });
  ...
  var import_toast4 = __toESM(require_toast());
  ...
  async function flagSubmit(attemptFlag, challenge, flagsHash, caseInsensitive) {
    ...
    if (flagsHash.includes(checkFlagHash)) {
      const toast = new import_toast4.default(document.getElementById("toast-challenge-flag-correct"));
      toast.show();
    } else {
      const toast = new import_toast4.default(document.getElementById("toast-challenge-flag-incorrect"));
      toast.show();
      return;
    }
    if (HackropoleApi.isLogged()) {
      ...
      if (!flaggedChallenges.includes(challenge)) {
        HackropoleApi.submission(challenge, attemptFlag).then((d) => {
          ...
          const toast = new import_toast4.default(document.getElementById("toast-api-error"));
          toast.show();
        });
      }
    } else {
  ...
  window.addEventListener("load", () => {
    ...
    const modal = new import_modal.default("#modal-solution", {});
    document.getElementById("solution-form")?.addEventListener("submit", (event) => {
      event.preventDefault();
      const url = document.getElementById("solution_url").value;
      if (!url.startsWith("https://gist.github.com/") && !url.startsWith("https://gitlab.com/")) {
        const toast = new import_toast4.default(document.getElementById("toast-writeup-submit-bad-url"));
        toast.show();
        return;
      }
      modal.show();
    ...
    document.getElementById("solution-confirm").addEventListener("click", () => {
      ...
      HackropoleApi.submitWriteUp(challenge, url).then((d) => {
        ...
        const toast = new import_toast4.default(document.getElementById("toast-writeup-submit-successful"));
        toast.show();
      }).catch(() => {
        const toast = new import_toast4.default(document.getElementById("toast-writeup-error"));
        toast.show();
      });
    });
  });
