...
(() => {
      ...
      e = exports, t = function() {
        ...
        function E(e3) {
          ...
          return new Promise(function(r2, i2) {
            var o2, s2, u2;
            if (o2 = e3.placeHolder, u2 = { role: "combobox", "aria-owns": (s2 = e3.resultsList).id, "aria-haspopup": true, "aria-expanded": false }, a(e3.input, t2(t2({ "aria-controls": s2.id, "aria-autocomplete": "both" }, o2 && { placeholder: o2 }), !e3.wrapper && t2({}, u2))), e3.wrapper && (e3.wrapper = a("div", t2({ around: e3.input, class: e3.name + "_wrapper" }, u2))), s2 && (e3.list = a(s2.tag, t2({ dest: [s2.destination, s2.position], id: s2.id, role: "listbox", hidden: "hidden" }, s2.class && { class: s2.class }))), T2(e3), e3.data.cache) return d(e3).then(function(e4) {
              try {
                return c2.call(n2);
              } catch (e5) {
                return i2(e5);
        ...
        function x(e3) {
          ...
          t3.init = function() {
            ...
            var t4;
            S2((t4 = this).events, function(e5, n2) {
  ...
  function fillLogin() {
    ...
    providers.forEach((provider) => {
      ...
      const text2 = document.createTextNode(`${menu.dataset.prefix}${provider.name}`);
  ...
  // ns-hugo-imp:C:\Users\n1NjaM0nk3y\Coding\n1NjaMonk3y\themes\hackropole\assets\js\vendor\katex\katex.mjs
  ...
  // ns-hugo-imp:C:\Users\n1NjaM0nk3y\Coding\n1NjaMonk3y\themes\hackropole\assets\js\vendor\katex\contrib\auto-render.mjs
